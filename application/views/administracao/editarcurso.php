        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body">
              <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/administracao/editcurso/<?php echo $objCurso->cd_curso; ?>">

                <!-- Form -->
                <div class="form-group">
                  <label for="inputStandard" class="col-lg-2 control-label">Sigla: </label>
                    <div class="col-lg-10">
                      <input type="text" id="inputStandard" name="sigla" value="<?php echo $objCurso->sgl_curso; ?>" class="form-control" placeholder="" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputStandard" class="col-lg-2 control-label">Título do Curso: </label>
                    <div class="col-lg-10">
                      <input type="text" id="inputStandard" name="titulo" value="<?php echo $objCurso->nm_curso; ?>" class="form-control" placeholder="" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputStandard" class="col-lg-2 control-label">Descrição: </label>
                    <div class="col-lg-10">
                      <textarea class="ckeditor editor1" id="editor1" name="descricao" rows="14"><?php echo $objCurso->ds_curso; ?></textarea>
                    </div>
                </div>
